...
To display the text-based pipeline visualizations, BOOM generates trace compatible with the O3 Pipeline Viewer included in the gem5 simulator suite.\cite{gem5} 
